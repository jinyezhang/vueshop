...
<style scoped>
    ...
    .cellphone-wrap .cellphone input,.code-wrap input,.password-wrap .password input{width:92%;height:82%;font-size:0.28rem;padding-left:0.2rem;}
    ...
    .inputs input{width:80%;height:82%;}
</style>
