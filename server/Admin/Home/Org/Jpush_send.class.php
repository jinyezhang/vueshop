<?php
class Jpush_send{
        private $app_key = 'db1171449d38a3fc3331fe4f';        //待发送的应用程序(appKey)，只能填一个。
        private $master_secret = 'caecd10154a8ee4f7e4dbfda';    //主密码
        ...
        public function send_pub($receive,$content,$m_type,$m_time){
           
            $m_time = '86400';//离线保留时间
            
            $message="";//存储推送状态
            $result = $this->push($receive,$content,$m_type,$m_time);
            if($result){
        ...
        public function push($receiver='all',$content,$m_type,$m_time='86400'){
            ...
            /*$data['message'] = array(
                    "msg_content"=>$content,
                    "extras"=>array("type"=>$m_type, "myid"=>$myid,"targetid"=>$targetid,'csname'=>$csname)
            );*/
