...
&nbsp;&nbsp;&nbsp;功能菜单</span>
    ...
    <div id="main-div">
        <div id="menu-list">
        	<ul>
              <li class="explode">
                <span ><a href="/hadmin.php/Home/Reviewsmanage/setting" target="mainframe">评价设置</a></span>
              </li>
            </ul>
            
            <ul>
              <li class="explode">
                <span><a href="/hadmin.php/Home/Reviews/manage" target="mainframe">活动评价</a></span>
              </li>
            </ul>
            
            <ul>
              <li class="explode">
                <span ><a href="/hadmin.php/Home/Reviewsmanage" target="mainframe">星级服务管理</a></span>
              </li>
            </ul>
