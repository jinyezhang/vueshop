        ...
        <div id="menu-list">
            <ul>
              <li class="explode" name="menu">
                <div class="menu" title="menu">会员管理</div>
                <ul>
                	<li class="menu-item"><a href="/hadmin.php/Home/User/manage?utype=0" target="mainframe">查看会员</a></li>
                      <li class="menu-item"><a href="/hadmin.php/Home/User/add" target="mainframe">添加会员</a></li>
                </ul>
              </li>
            </ul>
        </div>
