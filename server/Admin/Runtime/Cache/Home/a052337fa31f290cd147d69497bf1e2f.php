...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <!--左侧菜单-->
        <iframe name="leftframe" id="leftframe" frameborder="0" width="100%" height="100%" scrolling="auto" style="overflow:visible;" src="/hadmin.php/Home/Reviews/left"></iframe>
        <!--左侧菜单结束-->        </td>
        ...
        <!--内容主窗口-->
        <iframe name="mainframe" id="mainframe" frameborder="0" width="100%" height="100%" scrolling="auto" style="overflow:visible;" src="/hadmin.php/Home/Reviews/manage"></iframe></td>
    </tr>
</table>
