...
class  IndexComponent extends React.Component{
    ...
    componentDidMount(){
        ...
        this.getGoodsLevel();
        this.getReco();
        this.fnEventScroll=this.eventScroll.bind(this);
        window.addEventListener("scroll",this.fnEventScroll,false);
    }
    componentWillUnmount(){
        window.removeEventListener("scroll",this.fnEventScroll);
